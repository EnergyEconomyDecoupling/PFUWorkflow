...
plan <- SEAPSUTWorkflow::get_plan(countries = c("GHA", "ZAF"), 
                                  ...
                                  p_industry_prefixes = "<<Primary industry prefixes>>",
...
* `<<Final demand sectors>>` is a character vector of final demand sectors desired for analysis
* `<<Primary industry prefixes>>` is a character vector of primary industry prefixes (usually "Resources",    "Imports", and "Stock changes").
