...
#' @param report_output_folder The path into which reports will be written. Default is `tempdir()`.
...
set_up_for_testing <- function(countries = c("GHA", "ZAF"),
  ...
  set_up_temp_analysis(fu_analysis_folder, exemplar_folder, report_output_folder, iea_data_path, setup_exemplars = setup_exemplars)
...
#' @param report_output_folder The folder into which reports will be written.
...
#'
#' @noRd
set_up_temp_analysis <- function(fu_folder, exemplar_folder, report_output_folder, iea_data_path, setup_exemplars = FALSE) {
  # Set up IEA data
  ...
  dir.create(report_output_folder, showWarnings = FALSE)
